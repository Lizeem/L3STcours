...
![Les différents compartiments](Images/compartiments.PNG)
...
![Les types d'HAP](Images/hap.PNG)
...
![Les deux types de dépôts](Images/comportement.PNG)
...
![Comportement dans l'eau](Images/eau.PNG)
